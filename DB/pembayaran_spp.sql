...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 19, 2022 at 04:58 AM
...
(1, 'XIIRB', 'Rekayasa Perangkat Lunak', 0, NULL, 1),
(2, 'XIIRC', 'Rekayasa Perangkat Lunak', 0, 1, NULL),
(3, 'XIIRA', 'Rekayasa Perangkat Lunak', 0, 1, 1),
(4, 'XRA', 'Rekayasa Perangkat Lunak', 0, 1, 1);
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'win', 'admin', 0);
...
('123', NULL, 'er', 2, '', '', 1, 0, NULL, NULL),
('12345012', '7344', 'winarno', 4, NULL, NULL, 1, 0, NULL, NULL);
...
INSERT INTO `spp` (`id_spp`, `tahun`, `nominal`, `status`, `crated_id`, `update_id`) VALUES
(1, 2021, 20000, 0, NULL, NULL);
